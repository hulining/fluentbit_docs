...
| Streams\_File | Path for the Stream Processor configuration file. To learn more about Stream Processing configuration go [here](https://docs.fluentbit.io/manual/stream-processing/introduction). | 流式处理器配置文件路径。有关流式处理配置，参见[这里](../../stream-processing/introduction.md) |  |
